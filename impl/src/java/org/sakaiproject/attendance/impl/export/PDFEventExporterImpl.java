...
package org.sakaiproject.attendance.impl.export;
...
import org.sakaiproject.attendance.impl.export.util.SortNameUserComparator;
...
/**
 * Implementation of PDFEventExporter, {@link PDFEventExporter}
 *
...
public class PDFEventExporterImpl implements PDFEventExporter {
    ...
    private void buildDocumentShell(OutputStream outputStream, boolean isSignInSheet) {
        ...
        try {
            ...
            String eventDateString = eventDate==null?"":" (" + formatter.format(eventDate) + ")";
